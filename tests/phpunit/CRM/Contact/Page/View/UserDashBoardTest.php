...
class CRM_Contact_Page_View_UserDashBoardTest extends CiviUnitTestCase {
  ...
  public function testDashboardContentContributionsWithInvoicingEnabled() {
    ...
    $expectedStrings = [
      ...
      '<td>Completed</td><td><a class="button no-popup nowrap"href="/index.php?q=civicrm/contribute/invoice&amp;reset=1&amp;id=1&amp;cid=' . $this->contactID . '"><i class="crm-i fa-print"></i><span>Print Invoice</span></a></td><td',
      'Pay Now',
    ];
