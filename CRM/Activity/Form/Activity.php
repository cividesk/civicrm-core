...
class CRM_Activity_Form_Activity extends CRM_Contact_Form_Task {
  ...
  public function preProcess() {
    ...
    if ($this->_action & CRM_Core_Action::UPDATE) {
      ...
      $this->_values['details'] = CRM_Utils_String::stripAlternatives(CRM_Utils_Array::value('details', $this->_values)) ?: '';
    ...
    if ($this->_action & CRM_Core_Action::VIEW & !empty($this->_values['subject'])) {
