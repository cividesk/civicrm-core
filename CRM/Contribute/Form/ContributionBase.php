...
&& CRM_Contribute_PseudoConstant::financialType($this->_values['financial_type_id'])
        ...
        CRM_Core_Error::statusBounce(ts('You do not have permission to access this page. -'.CRM_Contribute_PseudoConstant::financialType($this->_values['financial_type_id'])));
      }
