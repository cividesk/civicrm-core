 ...
 */
class CRM_Event_Form_Task_Activity extends CRM_Event_Form_Task {
  ...
  public function preProcess() {
    ...
    elseif ($this->_context == 'search') {
      ...
      elseif ($path == 'civicrm/group/search'
        ...
        $urlString = 'civicrm/event/search';
      }
      $this->assign('searchKey', $qfKey);
    }
  ...
  public function buildQuickForm() {
    ...
    $this->addFormRule(array('CRM_Event_Form_Task_Activity', 'formRule'), $this);
