  ...
  public static function getChartCriteria() {
    return array(
      'count' => array(
        ...
        'civicrm_mailing_event_trackable_url_open_click_count' => ts('Click-throughs'),
        'civicrm_mailing_event_unsubscribe_unsubscribe_count' => ts('Unsubscribe Requests'),
      ),
      'rate' => array(
