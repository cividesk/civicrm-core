 ...
 *
 */
class CRM_Event_Page_ParticipantListing_NameRoleAndDate extends CRM_Core_Page {
...
LIMIT    $offset, $rowCount";
    ...
    while ($object->fetch()) {
      ...
      $allRoleIDs = explode(CRM_Core_DAO::VALUE_SEPARATOR, $object->role_id);
      $viewRoles = array();
