...
class CRM_Custom_Form_Group extends CRM_Core_Form {
  ...
  public static function formRule($fields, $files, $self) {
    ...
    $extends = ['Activity', 'Relationship', 'Group', 'Contribution', 'ContributionPage', 'Membership', 'Event', 'Participant'];
  ...
  public function buildQuickForm() {
    ...
    $sel2['ContributionPage'] = CRM_Contribute_PseudoConstant::contributionPage();
