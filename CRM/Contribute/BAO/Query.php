...
class CRM_Contribute_BAO_Query extends CRM_Core_BAO_Query {
  ...
  public static function buildSearchForm(&$form) {
    ...
    // using payment_instrument instead of payment_instrument_id
    // Contribution Edit form (pop-up on contribution/Contact(display Result as Contribution) search form),
    // payment method change action not working properly because of same html ID present on one page
    // To avoid this issue changing search form element name with out _id, then on search form submit assigning value back to payment_instrument_id
